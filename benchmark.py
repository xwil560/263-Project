...
def temperature_benchmark2():
    ''' Check if the temperature fit the model in the second scenario of the solver
    ...
    ax1.plot(ts, xsn, '-x')
    ax1.plot(ts, xsa, '-')
    ax1.title.set_text('Temperature Benchmark 2')
    ax1.set_ylabel("Temperature(degrees C)")
    ax1.set_xlabel("Time (days)")
